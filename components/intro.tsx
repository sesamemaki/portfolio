...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] text-center pt-24 sm:mb-0 scroll-mt-[100rem]"
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-28 w-28 -mt-4 object-cover rounded-full border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
          {/* <motion.span
      ...
      >
        ...
        <a
          href="/BurcuBayram_CV-2023.11.22.pdf"
          download
