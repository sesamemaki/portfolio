    ...
    >
      ...
      >
        ...
        <a
          ...
          download
          className="group bg-white px-7 py-3 flex item-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition border border-black/10"
        >
          Download CV{" "}
        ...
        <a
          ...
          target="_blank"
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-[1.15] transition border border-black/10"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
